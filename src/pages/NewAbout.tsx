...
import pastorGavu from '@/assets/pastor-gavu.jpg';
import pastorMaston from '@/assets/pastor-maston.jpg';
import pastorCatherine from '@/assets/pastor-catherine.jpg';
import pastorEricTady from '@/assets/pastor-eric-tady.jpg';
import pastorEricNyundi from '@/assets/pastor-eric-nyundi.jpg';
import pastorEmmanuel from '@/assets/pastor-emmanuel.jpg';
import boydDaka from '@/assets/boyd-daka.jpg';
import sydneyMutondo from '@/assets/sydney-mutondo.jpg';
import samsonSilungwe from '@/assets/samson-silungwe.jpg';
import paulNyirongo from '@/assets/paul-nyirongo.jpg';
import wanipaMusowoya from '@/assets/wanipa-musowoya.jpg';
import shadreckSilungwe from '@/assets/shadreck-silungwe.jpg';
import sethMusakanya from '@/assets/seth-musakanya.jpg';
              ...
              <Card className="max-w-md text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-32 h-32 rounded-full mx-auto mb-4 overflow-hidden">
                    <img src={pastorGavu} alt="Pastor Gavu Nyirongo" className="w-full h-full object-cover" />
                  </div>
                    ...
                    <DialogContent className="max-w-2xl">
                      ...
                      <div className="space-y-4">
                        <div className="flex items-start space-x-4">
                          <img src={pastorGavu} alt="Pastor Gavu" className="w-24 h-24 rounded-full object-cover" />
                          <div className="flex-1">
                            <p className="text-gray-600 leading-relaxed">
                              Pastor Gavu Nyirongo is the founding pastor of Mercy Seat Ministries, called by God to establish 
                              this ministry in 2010. With over 15 years of ministry experience, he has a heart for evangelism, 
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
                    <img src={pastorMaston} alt="Pastor Maston Musowoya" className="w-full h-full object-cover" />
                  </div>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
                    <img src={pastorCatherine} alt="Pastor Catherine Chewe" className="w-full h-full object-cover" />
                  </div>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
                    <img src={pastorEricTady} alt="Pastor Eric Tady" className="w-full h-full object-cover" />
                  </div>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
                    <img src={pastorEricNyundi} alt="Pastor Eric Nyundi" className="w-full h-full object-cover" />
                  </div>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
                    <img src={pastorEmmanuel} alt="Pastor Emmanuel Chindawi" className="w-full h-full object-cover" />
                  </div>
          ...
          <div className="mb-12">
            ...
            <div className="flex justify-center">
              <Card className="max-w-md text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-32 h-32 rounded-full mx-auto mb-4 overflow-hidden">
                    <img src={boydDaka} alt="Boyd Daka" className="w-full h-full object-cover" />
                  </div>
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
                    <img src={sydneyMutondo} alt="Sydney Mutondo" className="w-full h-full object-cover" />
                  </div>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
                    <img src={samsonSilungwe} alt="Samson Silungwe" className="w-full h-full object-cover" />
                  </div>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardHeader>
                  <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
                    <img src={paulNyirongo} alt="Paul Nyirongo" className="w-full h-full object-cover" />
                  </div>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
                  <img src={wanipaMusowoya} alt="Wanipa Musowoya" className="w-full h-full object-cover" />
                </div>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
                  <img src={shadreckSilungwe} alt="Shadreck Silungwe" className="w-full h-full object-cover" />
                </div>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="w-24 h-24 rounded-full mx-auto mb-4 overflow-hidden">
                  <img src={sethMusakanya} alt="Seth Musakanya" className="w-full h-full object-cover" />
                </div>
